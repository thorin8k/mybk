...
CREATE TABLE `inoutline` (
  ...
  CONSTRAINT `fk_inoutline_inout1` FOREIGN KEY (`inout_id`) REFERENCES `inout` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_inoutline_product1` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
