...
CREATE TABLE `pm_access_rules` (
  ...
  CONSTRAINT `fk_access_rules_actions1` FOREIGN KEY (`action_id`) REFERENCES `pm_actions` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_access_rules_profile1` FOREIGN KEY (`profile_id`) REFERENCES `pm_profile` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_access_rules_sections1` FOREIGN KEY (`section_id`) REFERENCES `pm_sections` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
